            ...
            <div className="mt-8 space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800 mb-3">
                      Our AI-powered system has analyzed your transactions for potential financial risks including money laundering, fraud, and regulatory compliance issues.
                    </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-3xl font-bold text-red-600 mb-1">{riskGroups.high_risk.length}</p>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-semibold text-orange-800">Risky</h3>
                  </div>
                  <p className="text-3xl font-bold text-orange-600 mb-1">{riskGroups.risky.length}</p>
                  <p className="text-sm text-orange-600 font-medium">transactions flagged</p>
                  <p className="text-xs text-orange-500 mt-2">Monitor closely</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border-2 border-yellow-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-semibold text-yellow-800">Low Risk</h3>
                  </div>
                  <p className="text-3xl font-bold text-yellow-600 mb-1">{riskGroups.low_risk.length}</p>
                  <p className="text-sm text-yellow-600 font-medium">transactions flagged</p>
                  <p className="text-xs text-yellow-500 mt-2">Review if needed</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-200 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-3xl font-bold text-green-600 mb-1">{riskGroups.safe.length}</p>
                  <p className="text-sm text-green-600 font-medium">transactions</p>
                  <p className="text-xs text-green-500 mt-2">No concerns detected</p>
                </div>
              </div>
              ...
              {Object.entries(riskGroups).map(([riskLevel, transactions]) => {
                ...
                return transactions.length > 0 && (
                  <div key={riskLevel} className={`border-2 rounded-xl p-6 ${getRiskColor(riskLevel)}`}>
